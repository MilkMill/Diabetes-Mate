 ...
 */
  render() {
    ...
    return (
      ...
      <ListItemRewrite indexSelected={indexSelected} modal={modal}/>

 <Text>Показатель глюкозы выбранной записи - {glucoseSelected}</Text>
 <Text>индекс записи {indexSelected}</Text>
        <Button
        title='Close modal'
